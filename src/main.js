...
import wikiPulseLayer from './data/wikiPulse.js';
import indianHistoryLayer from './data/indianHistory.js';
...
async function init() {
  ...
  try {
    ...
    dataManager.register(wikiPulseLayer);
    dataManager.register(indianHistoryLayer);
